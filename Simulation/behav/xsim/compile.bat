...
REM
REM Generated by Vivado on Tue Feb 17 10:34:30 +0530 2026
...
echo "xvlog --incr --relax -prj tb_distance_engine_vlog.prj"
call xvlog  --incr --relax -prj tb_distance_engine_vlog.prj -log xvlog.log
